...
void example_bfv_basics()
{
	...
	decryptor.decrypt(x_times_y, ans_original);
		
	ans_correct = ans_original.data()[i];
  		
    	x_times_y.data(1)[0] = x_times_y.data(1)[0] + 1;
    	x_times_y.data()[i] = x_times_y.data()[i];
    		
    	decryptor.decrypt(x_times_y, ans);
	...
	else//perturbation caused result to flip
	{
		...
		ans_correct = ans_original.data()[i];
    		...
    		x_times_y.data(1)[0] = x_times_y.data(1)[0] + 1;
    		x_times_y.data()[i] = x_times_y.data()[i] + 1;
